...
const sv = {
  ...
  splitByIncome: 'I proportion till inkomst',
  splitEven: 'Delas lika',
  splitHintEqualLeftover: 'Den som tjänar mest betalar en större del av kostnaderna.',
  splitHintByIncome: 'Det som blir kvar står i samma proportion som inkomsterna.',
  splitHintEven: 'Den som tjänar minst får mindre kvar.',
  each: 'var',
  expenses: 'Utgifter',
  incomes: 'Inkomster',
  shared: 'Gemensamma',
...
const en: { [K in keyof typeof sv]: (typeof sv)[K] extends string ? string : (typeof sv)[K] } = {
  ...
  splitByIncome: 'In proportion to income',
  splitEven: 'Split down the middle',
  splitHintEqualLeftover: 'The higher earner covers more of the costs.',
  splitHintByIncome: 'What each has left stays in the same proportion.',
  splitHintEven: 'The lower earner is left with less.',
  each: 'each',
  expenses: 'Expenses',
  incomes: 'Income',
  shared: 'Shared',
