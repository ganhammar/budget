...
const sv = {
  ...
  splitEqualLeftover: 'Lika mycket kvar',
  splitByIncome: 'Efter inkomst',
  splitEven: 'Lika delat',
  splitHintEqualLeftover: 'Alla får lika mycket kvar. Den som tjänar mest betalar mer.',
  splitHintByIncome: 'Kostnaderna delas i samma proportion som inkomsterna.',
  splitHintEven: 'Kostnaderna delas mitt itu, oavsett inkomst.',
  each: 'var',
  expenses: 'Utgifter',
  incomes: 'Inkomster',
  shared: 'Gemensamma',
...
const en: { [K in keyof typeof sv]: (typeof sv)[K] extends string ? string : (typeof sv)[K] } = {
  ...
  splitRule: 'Split',
  splitEqualLeftover: 'Equal left over',
  splitByIncome: 'By income',
  splitEven: 'Split evenly',
  splitHintEqualLeftover: 'Everyone ends up with the same left over. The higher earner pays more.',
  splitHintByIncome: 'Costs are divided in the same proportion as the incomes.',
  splitHintEven: 'Costs are divided down the middle, whatever the incomes.',
  each: 'each',
  expenses: 'Expenses',
  incomes: 'Income',
  shared: 'Shared',
